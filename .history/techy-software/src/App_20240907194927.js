  ...
  return (
    ...
    <div className="App">
      ...
      <section id="home" className="section home">
        ...
        <p>At Nexus Info, we provide innovative software solutions for your business needs.</p>
      ...
      <section id="services" className="section services">
        <h2>Our Services</h2>
        <p>We offer a range of software services including Web Development and Digital Marketing.</p>
      </section>
      ...
      <footer>
        <div className="social-media">
          <h3>Contact Us</h3>
          <a href="https://www.facebook.com/share/chBu6tfu8D9P88vq/?mibextid=LQQJ4d">Facebook</a>
          <a href="https://www.instagram.com/nexusinfo.in/">Instagram</a>
          <a href="https://www.linkedin.com/company/nexus-software-pvt-ltd/posts/?feedView=all">LinkedIn</a>
        </div>
      </footer>
    </div>
  );
